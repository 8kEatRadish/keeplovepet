...
@SupportedAnnotationTypes({"com.konka.libnavannotation.FragmentDestination","com.konka.libnavannotation.ActivityDestination"})
public class NavProcessor extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        if (!fragmentElements.isEmpty() || !activityElements.isEmpty()){
            HashMap<String, JSONObject> dest = new HashMap<>();
            handleDestination(fragmentElements,FragmentDestination.class,dest);
            handleDestination(activityElements,ActivityDestination.class,dest);
            //app/src/main/assets
            ...
            try {
                ...
                String content = JSON.toJSONString(dest);
